...
<body>
  <div class="container-fluid mt-1 p-5" style="width: 70%">
    ...
    <form id="formData">
      ...
      <input type="text" id="name_of_detail" name="name_of_detail" class="form-control" />
      <label for="value_of_detail" class="form-label">Enter value of detail</label>
      <input type="text" id="value_of_detail" name="value_of_detail" class="form-control" />
      <div>
  ...
  <script>
    $(document).ready(function () {
      $("#formData").on("submit", function (e) {
        e.preventDefault();
        $.ajax({
          url: "../employee_backend/edit2.php",
          type: "POST",
